...
public class Board {
	...
	/*
	 * public static void main(String [] args) { // DEBUGGING!!! Board b = new Board();
	 * 
	 * b.calcTargets(b.calcIndex(14,0), 6); /*Set<BoardCell> targets = b.getTargets(); for (BoardCell t : targets) { int first = t.getIndex() / 23; int second = t.getIndex() % 23;
	 * System.out.println(first + " " + second + " <-----"); } System.out.println("TargetSet Contents: "); Set<BoardCell> targets = b.getTargets(); for (BoardCell t : targets) {
	 * System.out.println(t.getIndex()); } LinkedList<Integer> ll = b.getAdjList(b.calcIndex(15, 2)); System.out.println("BEFORE NEXT"); for( int l : ll) { System.out.println(l); }/*
	 * b.calcTargets(b.calcIndex(21,7), 1); targets = b.getTargets(); System.out.println("NEXT"); for (BoardCell t : targets) { System.out.println(t.getIndex() + " "); } }
	 */
}
